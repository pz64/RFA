...
class RationalResampler(
    ...
    init {
        ...
        Log.d(
            LOGTAG,
            "designResamplerTaps generated ${staps.size} taps. (interpolation=${interpolation}, decimation=${decimation}, d=$d)"
        )
    ...
    companion object {
        ...
        fun limitDenominator(
            ...
            return if (lowerError < upperError) Pair(lowerNum, lowerDen) else Pair(
                upperNum,
                upperDen
            )
        }
